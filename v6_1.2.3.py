...
# Training function with L1 regularization and early stopping
...
def objective(lr, num_epochs, batch_size, k_folds, nHidden_index, momentum, dropout_rate, l1_lambda):
    ...
    return avg_val_accuracies['none']  # Return 'none' as the default optimization target
